...
export default function Menu() {
    ...
    return <>
        <div className="divconnectcontainer" id="connectContainer" style={{ opacity: openMenuConnect ? '1' : '0' }}>
            <img src="images/chart.png" loading="lazy" alt="" className="image-18" ref={imageQrCodeMaiar} />
            ...
            <div className="divbuttonsconnect">
                <div className="divmaiarappconnect" ref={buttonMaiarAppConnect} onClick={clickMaiarApp}>
                    <a data-w-id="2431201b-c920-69ba-1cdf-23d39d3d43ff" className="button-connect-elrond w-button">Maiar App</a>
            ...
            <div className="af-class-navigation-items">
                ...
                <div className="af-class-navigation-wrap d-md-block" ref={menuNav}>
                    <nav role="navigation" className="af-class-navigation-items af-class-navigationlist w-nav-menu">
                        ...
                        <a className="af-class-button-2 w-button menu-button" onClick={clickConnectButton}>
